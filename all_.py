...
class volum_input(QtWidgets.QWidget):
	def __init__(self):
		super(volum_input, self).__init__()
		newfont = QtGui.QFont("Times", 14)

		self.horizontalSlider = QtWidgets.QSlider()
		# self.horizontalSlider.setGeometry(QtCore.QRect(40, 140, 160, 19))
		self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
		self.horizontalSlider.setObjectName("horizontalSlider")
		############################################################3

		self.doubleSpinBox = QtWidgets.QDoubleSpinBox()
		# self.doubleSpinBox.setGeometry(QtCore.QRect(90, 220, 91, 51))
		...
		self.doubleSpinBox.setFont(newfont)
		############################################################
		# self.grid_vol = QtWidgets.QGridLayout(self.widget_vol)
		# # self.vertical_vol.addLayout(self.for_volume.verticalLayout)
		# self.grid_vol.addWidget(self.for_volume.horizontalSlider,0,0,1,1)
		# self.vertical_vol.addWidget(self.for_volume.doubleSpinBox,1,0,1,1)
		self.volume_label = QtWidgets.QLabel()
		self.volume_label.setObjectName("volume_label")
		self.volume_label.setText("Set Volume (in ml)")
		self.volume_label.setFont(newfont)
